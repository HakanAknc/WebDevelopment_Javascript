...
let kitap1 = { isim: "Her Şeyi Düşünme", yazar: "Anne Bogel", fiyat: 25 + "TL", raf: "1.5.RAF" }
let kitap2 = { isim: "Hiçbir Karşılaşma Tesadüf Değildir", yazar: "Hakan Mengüç", fiyat: 56 + "TL", raf: "2.3.RAF" }
let kitap3 = { isim: "İnsan Neyle Yaşar", yazar: "Tolstoy", fiyat: 34 + "TL", raf: "3.4.RAF" }
let kitap4 = { isim: "Zafer Sızlanarak Kazanılmaz", yazar: "Haluk Tatar", fiyat: 45 + "TL", raf: "4.1.RAF" }
let kitap5 = { isim: "Herkes Saçını Okşayacak Bir Ele İthiyaç Duyar", yazar: "Fırat Çakır", fiyat: 90 + "TL", raf: "5.3.RAF" }
...
if(rafKod!=null){
    ...
    alert("Giriğiniz kitap kütüphanemizde bulunmamaktadır.");
}
